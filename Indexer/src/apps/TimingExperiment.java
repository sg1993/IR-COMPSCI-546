...
public class TimingExperiment {
    ...
    private String[] FOURTEEN_TERM_QUERY_SET = { "effects", "corneliu", "unearned", "luck", "burr",
            "vile", "indigne", "serviteur", "chequin", "were", "lisp", "affecting", "rains",
    ...
    public static void main(String[] args) {
        ...
        // Pass the invertedFileIndex and numDocs and create the retriever
